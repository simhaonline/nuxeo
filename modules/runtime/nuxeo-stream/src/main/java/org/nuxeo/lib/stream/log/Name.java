...
public class Name {
    ...
    private Name(String namespace, String name) {
        ...
        this.name = name;
        if (NAMESPACE_EMPTY.equals(namespace)) {
    ...
    public static Name ofUrn(String urn) {
        ...
        if (pos < 0) {
            return new Name(NAMESPACE_EMPTY, urn);
        }
    ...
    public static Name ofId(String id) {
        ...
        if (pos < 0) {
            return new Name(NAMESPACE_EMPTY, id);
        }
    ...
    protected static void checkNameSpace(String name) {
        if (!VALID_NAMESPACE_PATTERN.matcher(name).matches() & !NAMESPACE_EMPTY.equals(name)) {
